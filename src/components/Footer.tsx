    ...
    <footer className="site-footer">
      <div className="footer-grid">
        <section className="footer-column">
          ...
          <p className="footer-about-text">
            Our qualified electrical engineers provide 24/7 onsite support and
            have access to in house engineers who can provide assistance for
        ...
        <section className="footer-column">
          ...
          <div className="footer-contact-list">
            ...
            <p><strong>Email:</strong> info@dpower.com.sg</p>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-socials">
          ...
          <a href="https://wa.me/6597227574" target="_blank" rel="noreferrer" aria-label="WhatsApp">
            <svg viewBox="0 0 24 24" fill="currentColor">
